  ...
  <tr>
    <td align="center" style="padding:48px 24px 64px;">
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;">
        ...
        <!-- Compact cover on signature glow -->
        <tr>
          <td background="${siteUrl}/assets/email-glow.png" bgcolor="#18191B" align="center" style="background-color:#18191B;background-image:url('${siteUrl}/assets/email-glow.png');background-repeat:no-repeat;background-position:center center;background-size:100% 100%;padding:40px 0 44px;">
            <img src="${siteUrl}/assets/cover.webp" width="170" alt="Form Follows Brand — book cover" style="display:block;width:170px;max-width:46%;height:auto;margin:0 auto;border:0;outline:0;box-shadow:0 26px 50px -26px rgba(0,0,0,0.85);" />
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:28px 0 0;">
            ...
            <p style="margin:0 0 20px;font-family:Arial,Helvetica,sans-serif;font-size:10px;font-weight:700;letter-spacing:0.10em;text-transform:uppercase;color:#ED406B;">Author, Founder at Adaptitude</p>
